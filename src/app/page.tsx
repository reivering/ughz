...
export default function Home() {
  ...
  return (
    <main className="w-full relative bg-[#0d0d0d] overflow-hidden">
      ...
      <section className="relative w-full z-10 shadow-[0_-20px_60px_-15px_rgba(0,0,0,0.5)] bg-gradient-to-br from-[#fcfcfc] via-[#f9f9f9] to-[#f4f4f4] rounded-t-[40px] md:rounded-t-[80px]" id="about">
      ...
      <section className="relative w-full pt-20 md:pt-32 pb-32 md:pb-48 px-6 md:px-12 text-[#111] rounded-t-[40px] md:rounded-t-[80px] z-10 shadow-[0_-20px_60px_-15px_rgba(0,0,0,0.5)] overflow-hidden bg-gradient-to-t from-[#fcfcfc] via-[#fdf9f7] to-[#fcfcfc]" id="work">
        ...
        {/* Selected Works Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-16 md:gap-y-24 mb-32 md:mb-48 relative z-10">
          <ProjectCard 
